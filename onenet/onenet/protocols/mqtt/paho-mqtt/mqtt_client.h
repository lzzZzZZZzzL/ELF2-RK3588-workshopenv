 ...
 *
 * @file mqtt_client.h
 * @brief based onPahoMQTT MQTTClient-C\src\MQTTClient.h
 */
 ...
 *  @param client - the client object to use
 *  @param topic_filter - the topic filter set the message handler for
 *  @param message_handler - pointer to the message handler function or NULL to remove
 *  @return success code
 */
